...
{
    /**
     * The services of ondewo-csi-api. CSI is a thin orchestration layer over NLU, S2T and T2S, so
     * its api VENDORS those three protos and this client ships their stubs too - a consumer talks
     * to all four servers through this one package.
     *
    ...
    private const EXPECTED_SERVICE_CLIENTS = [
        \Ondewo\Csi\ConversationsClient::class,
