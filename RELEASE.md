...
## Release ONDEWO CSI PHP Client 1.0.0

### New Features

* Initial release of the ONDEWO CSI (Conversational Speech Interface) gRPC client for PHP. The whole client surface
  is generated from the [ondewo-csi-api](https://github.com/ondewo/ondewo-csi-api) protocol buffer definitions by the
