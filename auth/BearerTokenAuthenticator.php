 ...
 *
 * ```php
 * $client = new \Ondewo\Csi\ConversationsClient('csi.ondewo.com:443', [
 *     'credentials'     => \Grpc\ChannelCredentials::createSsl(),
 *     'update_metadata' => new \Ondewo\Csi\Auth\BearerTokenAuthenticator($token),
 * ]);
 * ```
 *
